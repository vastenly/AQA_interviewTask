...
Напишите код xUnit-теста, который будет проверять, 
действительно ли метод getRtriangle возвращает прямоугольный треугольник. 

Приведённый метод написан на Java, но при решении задачи можно использовать любой язык.
